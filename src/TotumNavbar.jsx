    ...
    <div className="navbar-wrapper">
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .mobile-nav { display:none; position:fixed; inset:0; background:white; z-index:9999; overflow-y:auto; padding:20px; }
        .mobile-nav.open { display:block; }

        .mobile-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:30px; padding-bottom:20px; border-bottom:2px solid #f0f0f0; }
