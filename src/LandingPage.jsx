    ...
    <div class="banner">
        ...
        <div class="decoration star">
            <svg viewBox="0 0 60 60" width="60" height="60">
                <path d="M30 5 L35 25 L55 30 L35 35 L30 55 L25 35 L5 30 L25 25 Z" stroke-width="2.5"/>
            </svg>
        </div>
        ...
        <div class="content">
            ...
            <p class="subtitle">For Students, Professionals, Apprentices & More</p>
            <p class="description">TOTUM means 'all' - because everyone deserves access to great savings. Trade union members, chartered professionals, NHS staff and more anywhere else.</p>
