...
const FAQSection = ({ isLoggedIn }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "TOTUM membership is incredibly affordable at just £14.99 per year for students and £4.99 for eligible professionals and public sector workers. Given the average member saves £243 annually, your membership pays for itself many times over! We also offer special promotions throughout the year for new members.",
    },
    {
      question: "What makes TOTUM different from other discount cards?",
      answer:
        "TOTUM is the UK's most widely recognized discount service with exclusive partnerships you won't find elsewhere. We offer 24/7 access via our website and mobile app, both online and in-store discounts, and are backed by NUS (National Union of Students). Plus, our card is accepted by more retailers than any other student discount service in the UK.",
    },
    {
      question: "How do I use my TOTUM card?",
      answer:
        "Using your TOTUM card is simple! For online shopping, just log in to your account, find the retailer, and use the unique discount code provided. For in-store purchases, show your digital TOTUM card (available in our app) or your physical card at checkout. Many retailers also integrate TOTUM verification directly into their checkout process for seamless savings.",
    },
  ];
  ...
  "
              ...
              >
                <span className="question-text text-left">{faq.question}</span>

                <span className="faq-icon">
                  <svg
                    className={`icon-plus w-5 h-5 transition-transform ${
