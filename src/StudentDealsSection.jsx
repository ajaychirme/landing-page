  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Asterisk */}
        <div className="absolute top-12 right-16 text-6xl text-white opacity-20 font-light">✱</div>

        {/* Heading Section */}
        <div className="text-center max-w-4xl mx-auto mb-12 -mt-8 relative z-10" style={{marginTop: '-2rem'}}>
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4 mt-0">
            The UK's No.1 Discount Card for All
          </h1>
          <p className="text-lg text-white opacity-95 leading-relaxed" style={{marginTop:'22px'}}>
